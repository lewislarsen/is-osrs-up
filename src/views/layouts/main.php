...
<nav class="navbar navbar-expand-lg mb-4">
    <div class="container">
        ...
        <div>
            ...
            <a href="https://github.com/lewislarsen/is-osrs-up" class="btn btn-outline-secondary btn-sm" target="_blank" title="View on GitHub">
...
<footer class="container mt-5 mb-3 text-muted">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <p>Not affiliated with Jagex Ltd. All Old School RuneScape assets and imagery belong to Jagex Ltd.</p>
        </div>
    </div>
</footer>

<!-- The theme toggle button will be added by JavaScript -->
